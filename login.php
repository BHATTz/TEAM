    ...
    <form method="post" action="login.php">
      <div class="container px-10 py-24 mx-auto flex flex-wrap items-center">
        ...
        >
          ...
          <input type="submit" name="submit" vlaue="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"></input>
          <button
