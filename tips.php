...
<!-- unsplash image -->
    ...
    <div class="rounded-lg h-64 overflow-hidden">
      <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/1200x500/?dairy products">
    </div>
      </div>
    </div>
  ...
  >
    <div class="mt-2">
      <a
        ...
        >Farm owners should retain cultivated areas or land to grow fodder crops for livestock. The land area depends mainly on the number of livestock. Usually, 1 acre of land is enough for about 7-10 COWS.
        Water and fodder - Both of these things should be plentiful as water helps in the growth of green fodder and fodder further helps in the proper rearing of cattle. </a
      >
    </div>
    </div>
  </div>
